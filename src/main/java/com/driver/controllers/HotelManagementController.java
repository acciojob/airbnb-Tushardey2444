...
public class HotelManagementController {
    ...
    public Hotel updateFacilities(List<Facility> newFacilities, String hotelName) {
        ...
        return HMS.updateFacility(hotelName,newFacilities);
    }
